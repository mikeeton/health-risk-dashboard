...
Do not report vulnerabilities in a public issue. Send a private report to the
project owner with reproduction steps, affected role/data, and expected impact.
Do not include real patient data, access tokens, passwords, or API keys.
